...
public class MainActivity extends AppCompatActivity {
    ...
    public void setUpNavigationDrawer() {
        ...
        data.add(new NavigationDrawerItem(R.string.settings, ta.getDrawable(R.styleable.images_settings), v -> startActivity(new Intent(getApplicationContext(), SettingsActivity.class))));
