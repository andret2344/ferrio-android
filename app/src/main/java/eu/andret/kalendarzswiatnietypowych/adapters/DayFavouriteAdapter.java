...
public class DayFavouriteAdapter extends ArrayAdapter<Holiday> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        SharedPreferences favourites = Data.getPreferences(context, Data.Prefs.FAVOURITES);
        Set<String> favs = // favourites.getStringSet(Data.favourites, new HashSet<String>());
        ...
        String today = getItem(position).getText();
